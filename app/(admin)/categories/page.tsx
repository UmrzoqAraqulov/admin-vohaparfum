...
export default function UsersP() {
  ...
  const handleOk = () => {
    form.validateFields().then((values: Category) => {
  ...
  return (
    ...
    <main className="pt-2 containr">
      {categories.length !== 0 ? (
        <div className="title flex text-white flex-wrap gap-2 justify-between items-center bg-white bg-opacity-20 backdrop-blur-md rounded-md px-3 py-2">
