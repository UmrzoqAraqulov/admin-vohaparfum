  ...
  return (
    <div className="containr">
            ...
            products?.map((pr) => (
              ...
              >
                ...
                <div className="p-2">
                  ...
                  <p className="text-white text-sm">Price: {pr?.price}</p>
                  <p className="text-white text-sm">Total: {pr?.quantity}</p>
                </div>
      ...
      {products.length !== 0 && !loading ? (
        <div className="flex justify-center bg-white py-2 bg-opacity-20 backdrop-blur-md rounded-md">
          <Pagination
            defaultCurrent={page}
            total={total}
            onChange={changePage}
